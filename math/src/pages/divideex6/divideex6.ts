...
@Component({
  selector: 'page-divideex6',
  templateUrl: 'divideex6.html',
})
export class Divideex6Page {

  
  ex3;
  ex3Url= 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/divide/compare/level6';
  Answer;
  index=0;
  score = 0;
  displayName:string;
