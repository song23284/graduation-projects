...
@Component({
  selector: 'page-add1-exer7',
  templateUrl: 'add1-exer7.html',
})
export class Add1Exer7Page {
  result = '';
  ex2Url='https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/addition/input/level7';
  ex2;
  Answer;
  index=0;
  score=0;
