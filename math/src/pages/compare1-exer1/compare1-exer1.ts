...
@Component({
  selector: 'page-compare1-exer1',
  templateUrl: 'compare1-exer1.html',
})
export class Compare1Exer1Page {

  ex1;
  ex1Url = 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/compare/multiplechoice/level2';
