...
/**
 * Generated class for the Ex3counterPage page.
 *
...
@Component({
  selector: 'page-ex3counter',
  templateUrl: 'ex3counter.html',
})
export class Ex3counterPage {
  url='https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/couter/multiplechoice/level2';
  ex1;
  answer;
  index=0
  DisplayName;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Ex3counterPage');
  }
