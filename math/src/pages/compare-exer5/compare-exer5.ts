...
@Component({
  selector: 'page-compare-exer5',
  templateUrl: 'compare-exer5.html',
})
export class CompareExer5Page {

  ex1;
  ex1Url = 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/compare/multiplechoice/level5';
