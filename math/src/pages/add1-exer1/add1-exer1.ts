...
@Component({
  selector: 'page-add1-exer1',
  templateUrl: 'add1-exer1.html',
  providers: [AngularFireAuth,AngularFireDatabase]

})
export class Add1Exer1Page {
 
  ex1;
  ex1Url = 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/addition/multiplechoice/level1';
