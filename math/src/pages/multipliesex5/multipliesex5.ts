...
/**
 * Generated class for the Multipliesex5Page page.
 *
...
@Component({
  selector: 'page-multipliesex5',
  templateUrl: 'multipliesex5.html',
})
export class Multipliesex5Page {

 ex3;
  ex3Url= 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/multiplication/compare/level5';
  Answer;
  index=0;
  score = 0;
  displayName:string;
