...
/**
 * Generated class for the Ex5counterPage page.
 *
...
@Component({
  selector: 'page-ex5counter',
  templateUrl: 'ex5counter.html',
})
export class Ex5counterPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Ex5counterPage');
  }
