...
/**
 * Generated class for the Ex7subPage page.
 *
...
@Component({
  selector: 'page-ex7sub',
  templateUrl: 'ex7sub.html',
})
export class Ex7subPage {
  result = '';
  ex2Url='https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/subtraction/input/level7';
  ex2;
  Answer;
  index=0;
  score=0;
