...
@Component({
  selector: 'page-add1-exer6',
  templateUrl: 'add1-exer6.html',
})
export class Add1Exer6Page {
  result = '';
  ex2Url='https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/addition/input/level6';
  ex2;
  Answer;
  index=0;
  score=0;
