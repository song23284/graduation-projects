...
@Component({
  selector: 'page-add1-exer5',
  templateUrl: 'add1-exer5.html',
})
export class Add1Exer5Page {
  result = '';
  ex2Url='https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/addition/input/level5';
  ex2;
  Answer;
  index=0;
  score=0;
