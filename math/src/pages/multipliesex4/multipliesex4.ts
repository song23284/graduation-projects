...
/**
 * Generated class for the Multipliesex4Page page.
 *
...
@Component({
  selector: 'page-multipliesex4',
  templateUrl: 'multipliesex4.html',
})
export class Multipliesex4Page {
  ex3;
  ex3Url= 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/multiplication/compare/level4';
  Answer;
  index=0;
  score = 0;
  displayName:string;
...
this.http.post("https://us-central1-mathapp-128.cloudfunctions.net/app/post/score/level1/multiplies", postData )
.subscribe(data => {
