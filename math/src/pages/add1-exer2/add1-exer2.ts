...
@Component({
  selector: 'page-add1-exer2',
  templateUrl: 'add1-exer2.html',
  providers: [AngularFireAuth,AngularFireDatabase]
})
export class Add1Exer2Page {
  result = '';
  ex2Url='https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/addition/input/level2';
  ex2;
  Answer;
  index=0;
  score=0;
