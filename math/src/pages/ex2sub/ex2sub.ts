...
@Component({
  selector: 'page-ex2sub',
  templateUrl: 'ex2sub.html',
})

export class Ex2subPage {
  result = '';
  ex2Url='https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/subtraction/input/level2';
  ex2;
  Answer;
  index=0;
  score=0;
