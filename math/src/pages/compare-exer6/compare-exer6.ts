...
@Component({
  selector: 'page-compare-exer6',
  templateUrl: 'compare-exer6.html',
})
export class CompareExer6Page {
  ex1;
  ex1Url = 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/compare/multiplechoice/level6';
