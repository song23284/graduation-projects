...
@Component({
  selector: 'page-multipliesex6',
  templateUrl: 'multipliesex6.html',
})
export class Multipliesex6Page {
  ex1;
  ex1Url = 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/multiplication/multiplechoice/level6';
