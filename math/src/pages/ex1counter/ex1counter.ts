...
@Component({
  selector: 'page-ex1counter',
  templateUrl: 'ex1counter.html',
})
export class Ex1counterPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Ex1counterPage');
  }
...
this.http.post("https://us-central1-mathapp-128.cloudfunctions.net/app/post/score/level1/counter", postData )
.subscribe(data => {
