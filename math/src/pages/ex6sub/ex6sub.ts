...
@Component({
  selector: 'page-ex6sub',
  templateUrl: 'ex6sub.html',
})
export class Ex6subPage {
  result = '';
  ex2Url='https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/subtraction/input/level6';
  ex2;
  Answer;
  index=0;
  score=0;
