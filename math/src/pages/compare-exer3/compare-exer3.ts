...
@Component({
  selector: 'page-compare-exer3',
  templateUrl: 'compare-exer3.html',
})
export class CompareExer3Page {

  ex1;
  ex1Url = 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/compare/multiplechoice/level3';
