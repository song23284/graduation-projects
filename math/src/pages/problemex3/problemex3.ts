...
@Component({
  selector: 'page-problemex3',
  templateUrl: 'problemex3.html',
})
export class Problemex3Page {

  result = '';
  ex2Url='https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/problem/input/level3';
  ex2;
  Answer;
  index=0;
  score=0;
