...
@Component({
  selector: 'page-multipliesex1',
  templateUrl: 'multipliesex1.html',
})
export class Multipliesex1Page {
  ex1;
  ex1Url = 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/multiplication/multiplechoice/level1';
