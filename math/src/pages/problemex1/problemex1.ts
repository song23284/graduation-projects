...
@Component({
  selector: 'page-problemex1',
  templateUrl: 'problemex1.html',
})
export class Problemex1Page {

  result = '';
  ex2Url='https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/problem/input/level1';
  ex2;
  Answer;
  index=0;
  score=0;
