...
@Component({
  selector: 'page-add1-exer4',
  templateUrl: 'add1-exer4.html',
})
export class Add1Exer4Page {
  Url = 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/addition/multiplechoice/level4';
  ex1;
  answer;
  ans:string;
  index=0;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Add1Exer4Page');
  }
