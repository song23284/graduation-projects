...
@Component({
  selector: 'page-problemex2',
  templateUrl: 'problemex2.html',
})
export class Problemex2Page {

  result = '';
  ex2Url='https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/problem/input/level2';
  ex2;
  Answer;
  index=0;
  score=0;
  ...
  getanswer(i){
   ...
   this.http.post("https://us-central1-mathapp-128.cloudfunctions.net/app/post/score/level1/problem", postData )
     .subscribe(data => {
