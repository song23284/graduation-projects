...
/**
 * Generated class for the Ex1subPage page.
 *
...
@Component({
  selector: 'page-ex1sub',
  templateUrl: 'ex1sub.html',
})
export class Ex1subPage {
  ex1;
  ex1Url = 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/subtraction/multiplechoice/level1';
