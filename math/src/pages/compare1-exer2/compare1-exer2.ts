...
/**
 * Generated class for the Compare1Exer2Page page.
 *
...
@Component({
  selector: 'page-compare1-exer2',
  templateUrl: 'compare1-exer2.html',
})
export class Compare1Exer2Page {
  ex3;
  ex3Url= 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/compare/compare/level1';
  Answer;
  index=0;
  score = 0;
  displayName:string;
