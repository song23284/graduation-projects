...
@Component({
  selector: 'page-ex4sub',
  templateUrl: 'ex4sub.html',
})
export class Ex4subPage {
  ex1;
  ex1Url = 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/subtraction/multiplechoice/level4';
