...
@Component({
  selector: 'page-multipliesex2',
  templateUrl: 'multipliesex2.html',
})
export class Multipliesex2Page {

  ex1;
  ex1Url = 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/multiplication/multiplechoice/level2';
