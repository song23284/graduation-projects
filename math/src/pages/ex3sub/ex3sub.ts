...
@Component({
  selector: 'page-ex3sub',
  templateUrl: 'ex3sub.html',
})
export class Ex3subPage {

  ex3;
  ex3Url= 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/subtraction/compare/level3';
  Answer;
  index=0;
  score = 0;
  displayName:string;
