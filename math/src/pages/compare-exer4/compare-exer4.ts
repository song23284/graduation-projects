...
/**
 * Generated class for the CompareExer4Page page.
 *
...
@Component({
  selector: 'page-compare-exer4',
  templateUrl: 'compare-exer4.html',
})
export class CompareExer4Page {
  ex1;
  ex1Url = 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/compare/multiplechoice/level4';
