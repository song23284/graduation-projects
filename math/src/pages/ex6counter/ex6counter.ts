...
/**
 * Generated class for the Ex6counterPage page.
 *
...
@Component({
  selector: 'page-ex6counter',
  templateUrl: 'ex6counter.html',
})
export class Ex6counterPage {

  url='https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/couter/multiplechoice/level3';
  ex1;
  answer;
  index=0
  DisplayName;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Ex6counterPage');
  }
