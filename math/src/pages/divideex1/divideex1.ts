...
/**
 * Generated class for the Divideex1Page page.
 *
...
@Component({
  selector: 'page-divideex1',
  templateUrl: 'divideex1.html',
})
export class Divideex1Page {

  ex1;
  ex1Url = 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/divide/multiplechoice/level1';
