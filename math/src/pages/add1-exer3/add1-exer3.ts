...
@Component({
  selector: 'page-add1-exer3',
  templateUrl: 'add1-exer3.html',
})
export class Add1Exer3Page {

  ex3;
  ex3Url= 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/addition/compare/level3';
  Answer;
  index=0;
  score = 0;
  displayName:string;
