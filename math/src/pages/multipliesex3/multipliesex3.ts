...
@Component({
  selector: 'page-multipliesex3',
  templateUrl: 'multipliesex3.html',
})
export class Multipliesex3Page {

  ex3;
  ex3Url= 'https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/multiplication/compare/level3';
  Answer;
  index=0;
  score = 0;
  displayName:string;
