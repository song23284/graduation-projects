...
@Component({
  selector: 'page-problemex4',
  templateUrl: 'problemex4.html',
})
export class Problemex4Page {
  result = '';
  ex2Url='https://us-central1-mathapp-128.cloudfunctions.net/app/get/exercise/problem/input/level4';
  ex2;
  Answer;
  index=0;
  score=0;
