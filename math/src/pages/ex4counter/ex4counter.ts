...
/**
 * Generated class for the Ex4counterPage page.
 *
...
@Component({
  selector: 'page-ex4counter',
  templateUrl: 'ex4counter.html',
})
export class Ex4counterPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Ex4counterPage');
  }
