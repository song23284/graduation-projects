...
document.getElementsByClassName(gogo)
...
var query = firebase.database().ref("exercise/addition/multiplechoice").child(level).orderByKey();
query.once("value")
...
cell5.innerHTML=childSnapshot.val().Choice;
