...
var query = firebase.database().ref("exercise/problem/input").child(level).orderByKey();
query.once("value")
...
var sd=JSON.stringify(childSnapshot.val().Question);
 ...
 cell2.innerHTML=childSnapshot.val().Question;
//  cell4.innerHTML=childSnapshot.val().Question.Operand2;
//  cell3.innerHTML=childSnapshot.val().Question.Operanddivide;
