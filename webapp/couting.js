...
var query = firebase.database().ref("exercise/couter/multiplechoice").child(level).orderByKey();
query.once("value")
...
btn.addEventListener('click',(e)=>{
  ...
  var firebaseRef = firebase.database().ref("exercise/couter/multiplechoice").child(level);
