...
var query = firebase.database().ref("exercise/compare/multiplechoice").child(level).orderByKey();
query.once("value")
...
// var sd=JSON.stringify(childSnapshot.val().Choice);
 var sd=childSnapshot.val().Choice;
...
cell6.innerHTML=childSnapshot.val().Question.Answer;
cell5.innerHTML=sd;
