...
var query = firebase.database().ref("exercise/multiplication/compare").child(level).orderByKey();
query.once("value")
...
var sd=JSON.stringify(childSnapshot.val().Question);
 ...
 cell3.innerHTML=childSnapshot.val().Question.Operandmultiplication;
...
btn.addEventListener('click',(e)=>{
  ...
  var firebaseRef = firebase.database().ref("exercise/multiplication/compare").child(level);
