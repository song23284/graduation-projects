function saveOnClick() {
	...
	insertData(exampleInputex.value, Operand1.value, Operanddivide.value, Operand2.value, Answer.value, level);
}
window.onload = function() {
	showData();
};

function insertData(exampleInputex, Operand1, Operanddivide, Operand2, Answer, level) {
	var firebaseRef = firebase.database().ref('exercise/divide/input').child(level);
	firebaseRef.push({
