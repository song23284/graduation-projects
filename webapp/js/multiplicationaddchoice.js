...
function showData() {
	...
	var rootRef = firebase.database().ref('exercise/multiplication').child('add1');
...
function insertData(
	...
	var firebaseRef = firebase.database().ref('exercise/multiplication/multiplechoice').child(level);
	firebaseRef.push({
