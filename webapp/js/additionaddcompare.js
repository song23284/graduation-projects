...
function insertData(exampleInputex, Operand1, Operandadd, Operand2, Answer, level, status) {
	var firebaseRef = firebase.database().ref('exercise/addition/compare').child(level);
	firebaseRef.push({
